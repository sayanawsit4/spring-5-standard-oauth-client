...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static List<String> clients = Arrays.asList("google", "facebook","vibe");
    ...
    private ClientRegistration getRegistration(String client) {
        ...
        if(client.equals("vibe")){
            ...
            builder.clientName("vibe");
            builder.registrationId(client);
            builder.clientId(clientId).clientSecret(clientSecret).build();
         }
